...
paramPhaseMgmt(SpotPhase.Phase3_3).phaseEnd =  30 + 30 + paramPhaseMgmt(SpotPhase.Phase3_2).phaseEnd;
paramPhaseMgmt(SpotPhase.Phase3_4).phaseEnd = 120 + 60 + paramPhaseMgmt(SpotPhase.Phase3_3).phaseEnd;
